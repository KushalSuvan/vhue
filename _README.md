...
<svg width="100%" height="180" viewBox="0 0 1200 180" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Flowing light trails in background -->
...
<svg width="100%" height="250" viewBox="0 0 1200 250" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <linearGradient id="roadGrad" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" style="stop-color:#1f2937;stop-opacity:0.5"/>
  ...
  <!-- Traffic light with pulsing red -->
  ...
  <g transform="translate(150, 115)">
    ...
    <!-- More cars fading into distance -->
...
<svg width="100%" height="400" viewBox="0 0 1200 400" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <linearGradient id="roadFade" x1="0%" y1="0%" x2="0%" y2="100%">
      ...
      <stop offset="50%" style="stop-color:#4b5563;stop-opacity:0.6"/>
      <stop offset="100%" style="stop-color:#374151;stop-opacity:0.3"/>
    </linearGradient>
  </defs>
  ...
  <g transform="translate(50, 50)">
    ...
    <g transform="translate(75, 100)">
      ...
      <!-- Cars evenly distributed (glowing) -->
  ...
  <g transform="translate(420, 50)">
    ...
    <g transform="translate(75, 100)">
      ...
      <!-- Heavy traffic from south (many cars) -->
      ...
      <!-- Light traffic other directions -->
      ...
      <!-- Smart traffic light (more time for busy direction) -->
  ...
  <g transform="translate(790, 50)">
    ...
    <g transform="translate(75, 100)">
      ...
      <!-- Emergency vehicle (pulsing red glow) -->
...
Equal traffic from all directions. The agent must learn basic safety: never allow conflicting movements.

- ✅ North-South green → East-West red
- ❌ Both green → **Instant termination**
- Collision penalty: **-10,000 reward**

</td>
<td width="33%" valign="top">

**🟡 Scenario 2: Non-Uniform Flow**

Asymmetric demand tests intelligent resource allocation.

- 📊 Adapt timing to queue lengths
- ⚖️ Balance throughput vs. fairness
- 🎯 Don't starve low-traffic directions

</td>
<td width="33%" valign="top">

**🔴 Scenario 3: Priority Vehicles**

Emergency vehicles demand immediate response.

- 🚨 Detect ambulances/fire trucks
- ⚡ Preempt current phase
- ⏱️ Every second = **10× penalty**
...
<svg width="100%" height="350" viewBox="0 0 1200 350" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Baseline (fixed timer) - dashed line -->
  ...
  <!-- Scenario 1: Uniform Flow (green) - with gradient fill -->
  ...
  <!-- Scenario 2: Non-Uniform (yellow) - with gradient fill -->
  ...
  <!-- Scenario 3: Emergency (red) - with gradient fill -->
  ...
  <!-- Legend box with modern styling -->
  ...
  <!-- Data points (final values) with glow -->
...
<table>
  <thead>
    <tr>
      ...
      <th align="center">Baseline (Fixed Timer)</th>
  ...
  <tbody>
    <tr>
      ...
      <td align="center"><strong>42s</strong></td>
      <td align="center">🔽 <strong>76%</strong></td>
    </tr>
    <tr>
      <td><strong>Throughput</strong></td>
      <td align="center">12 cars/min</td>
      <td align="center"><strong>28 cars/min</strong></td>
      <td align="center">🔼 <strong>133%</strong></td>
    </tr>
    <tr>
      <td><strong>Emergency Delay</strong></td>
      <td align="center">240s</td>
      <td align="center"><strong>18s</strong></td>
      <td align="center">🔽 <strong>92%</strong></td>
    </tr>
    <tr>
      <td><strong>Collision Rate</strong></td>
      <td align="center">0% (safe but slow)</td>
      <td align="center"><strong>0% (safe AND fast)</strong></td>
      <td align="center">✅</td>
    </tr>
  </tbody>
</table>
...
# https://huggingface.co/spaces/your-username/vhue
```
...
Made with 🚦 (and a lot of waiting in traffic) by ZephyrousChimes
